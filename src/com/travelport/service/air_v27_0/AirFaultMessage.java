...
public class AirFaultMessage extends Exception {
    ...
    public AirFaultMessage(String message, com.travelport.schema.common_v27_0.ErrorInfo errorInfo) {
        super(message);
        this.errorInfo = errorInfo;
    }

    public AirFaultMessage(String message, com.travelport.schema.common_v27_0.ErrorInfo errorInfo, Throwable cause) {
        super(message, cause);
        this.errorInfo = errorInfo;
    }
