...
public class AirService extends Service {
    ...
    public final static QName SERVICE = new QName("http://www.travelport.com/service/air_v27_0", "AirService");
    public final static QName AirFareRulesPort = new QName("http://www.travelport.com/service/air_v27_0", "AirFareRulesPort");
    public final static QName AirFareDisplayPort = new QName("http://www.travelport.com/service/air_v27_0", "AirFareDisplayPort");
    public final static QName AirRepriceSearchPort = new QName("http://www.travelport.com/service/air_v27_0", "AirRepriceSearchPort");
    public final static QName EMDRetrievePort = new QName("http://www.travelport.com/service/air_v27_0", "EMDRetrievePort");
    public final static QName SeatMapPort = new QName("http://www.travelport.com/service/air_v27_0", "SeatMapPort");
    public final static QName AirMerchandisingDetailsPort = new QName("http://www.travelport.com/service/air_v27_0", "AirMerchandisingDetailsPort");
    public final static QName AirRefundTicketPort = new QName("http://www.travelport.com/service/air_v27_0", "AirRefundTicketPort");
    public final static QName AirExchangeProcessPort = new QName("http://www.travelport.com/service/air_v27_0", "AirExchangeProcessPort");
    public final static QName AirScheduleSearchPort = new QName("http://www.travelport.com/service/air_v27_0", "AirScheduleSearchPort");
    public final static QName AirRetrieveDocumentBindingPort = new QName("http://www.travelport.com/service/air_v27_0", "AirRetrieveDocumentBindingPort");
    public final static QName FlightTimeTablePort = new QName("http://www.travelport.com/service/air_v27_0", "FlightTimeTablePort");
    public final static QName AirMerchandisingOfferAvailabilityPort = new QName("http://www.travelport.com/service/air_v27_0", "AirMerchandisingOfferAvailabilityPort");
    public final static QName AirLowFareSearchAsynchPort = new QName("http://www.travelport.com/service/air_v27_0", "AirLowFareSearchAsynchPort");
    public final static QName AirUpsellSearchPort = new QName("http://www.travelport.com/service/air_v27_0", "AirUpsellSearchPort");
    public final static QName AirAvailabilitySearchPort = new QName("http://www.travelport.com/service/air_v27_0", "AirAvailabilitySearchPort");
    public final static QName AirExchangeQuotePort = new QName("http://www.travelport.com/service/air_v27_0", "AirExchangeQuotePort");
    public final static QName AirRefundQuotePort = new QName("http://www.travelport.com/service/air_v27_0", "AirRefundQuotePort");
    public final static QName EMDIssuancePort = new QName("http://www.travelport.com/service/air_v27_0", "EMDIssuancePort");
    public final static QName AirTicketingPort = new QName("http://www.travelport.com/service/air_v27_0", "AirTicketingPort");
    public final static QName AirPrePayPort = new QName("http://www.travelport.com/service/air_v27_0", "AirPrePayPort");
    public final static QName AirPricePort = new QName("http://www.travelport.com/service/air_v27_0", "AirPricePort");
    public final static QName AirExchangeTicketingPort = new QName("http://www.travelport.com/service/air_v27_0", "AirExchangeTicketingPort");
    public final static QName AirRetrieveLowFareSearchPort = new QName("http://www.travelport.com/service/air_v27_0", "AirRetrieveLowFareSearchPort");
    public final static QName AirLowFareSearchPort = new QName("http://www.travelport.com/service/air_v27_0", "AirLowFareSearchPort");
    public final static QName AirVoidDocumentPort = new QName("http://www.travelport.com/service/air_v27_0", "AirVoidDocumentPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/pedroboza/eclipse-workspace/Travelport Tutorial/wsdl/air_v27_0/Air.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AirService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/pedroboza/eclipse-workspace/Travelport Tutorial/wsdl/air_v27_0/Air.wsdl");
        }
        WSDL_LOCATION = url;
    }
