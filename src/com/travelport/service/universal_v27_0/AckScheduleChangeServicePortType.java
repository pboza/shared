 ...
 * 2014-06-21T16:08:17.148-04:00
 * Generated source version: 3.0.0
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v27_0", name = "AckScheduleChangeServicePortType")
...
public interface AckScheduleChangeServicePortType {
    ...
    @WebResult(name = "AckScheduleChangeRsp", targetNamespace = "http://www.travelport.com/schema/universal_v27_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/ScheduleChangeService")
    public com.travelport.schema.universal_v27_0.AckScheduleChangeRsp service(
        @WebParam(partName = "parameters", name = "AckScheduleChangeReq", targetNamespace = "http://www.travelport.com/schema/universal_v27_0")
        com.travelport.schema.universal_v27_0.AckScheduleChangeReq parameters,
