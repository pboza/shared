 ...
 * 2014-06-21T16:08:17.056-04:00
 * Generated source version: 3.0.0
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v27_0", name = "AirMerchandisingFulfillmentPortType")
...
public interface AirMerchandisingFulfillmentPortType {
    ...
    @WebResult(name = "AirMerchandisingFulfillmentRsp", targetNamespace = "http://www.travelport.com/schema/universal_v27_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/AirService")
    public com.travelport.schema.universal_v27_0.AirMerchandisingFulfillmentRsp service(
        @WebParam(partName = "parameters", name = "AirMerchandisingFulfillmentReq", targetNamespace = "http://www.travelport.com/schema/universal_v27_0")
        com.travelport.schema.universal_v27_0.AirMerchandisingFulfillmentReq parameters,
