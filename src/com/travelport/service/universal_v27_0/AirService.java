...
public class AirService extends Service {
    ...
    public final static QName SERVICE = new QName("http://www.travelport.com/service/universal_v27_0", "AirService");
    public final static QName AirCreateReservationPort = new QName("http://www.travelport.com/service/universal_v27_0", "AirCreateReservationPort");
    public final static QName AirMerchandisingFulfillmentPort = new QName("http://www.travelport.com/service/universal_v27_0", "AirMerchandisingFulfillmentPort");
    public final static QName AirCancelPort = new QName("http://www.travelport.com/service/universal_v27_0", "AirCancelPort");
    static {
        URL url = null;
        try {
