 ...
 * 2014-06-21T16:08:17.103-04:00
 * Generated source version: 3.0.0
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v27_0", name = "HotelReservationServicePortType")
...
public interface HotelReservationServicePortType {
    ...
    @WebResult(name = "HotelCreateReservationRsp", targetNamespace = "http://www.travelport.com/schema/universal_v27_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/HotelService")
    public com.travelport.schema.universal_v27_0.HotelCreateReservationRsp service(
        @WebParam(partName = "parameters", name = "HotelCreateReservationReq", targetNamespace = "http://www.travelport.com/schema/universal_v27_0")
        com.travelport.schema.universal_v27_0.HotelCreateReservationReq parameters,
