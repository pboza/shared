...
public class PassiveService extends Service {
    ...
    public final static QName SERVICE = new QName("http://www.travelport.com/service/universal_v27_0", "PassiveService");
    public final static QName PassiveReservationServicePort = new QName("http://www.travelport.com/service/universal_v27_0", "PassiveReservationServicePort");
    public final static QName PassiveCancelServicePort = new QName("http://www.travelport.com/service/universal_v27_0", "PassiveCancelServicePort");
    static {
        URL url = null;
        try {
