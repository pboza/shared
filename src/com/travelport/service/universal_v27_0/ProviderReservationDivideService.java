...
public class ProviderReservationDivideService extends Service {
    ...
    public final static QName SERVICE = new QName("http://www.travelport.com/service/universal_v27_0", "ProviderReservationDivideService");
    public final static QName ProviderReservationDivideServicePort = new QName("http://www.travelport.com/service/universal_v27_0", "ProviderReservationDivideServicePort");
    static {
        URL url = null;
        try {
