 ...
 * 2014-06-21T16:08:17.121-04:00
 * Generated source version: 3.0.0
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v27_0", name = "SavedTripCreateServicePortType")
...
public interface SavedTripCreateServicePortType {
    ...
    @WebResult(name = "SavedTripCreateRsp", targetNamespace = "http://www.travelport.com/schema/universal_v27_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/SavedTripCreateService")
    public com.travelport.schema.universal_v27_0.SavedTripCreateRsp service(
        @WebParam(partName = "parameters", name = "SavedTripCreateReq", targetNamespace = "http://www.travelport.com/schema/universal_v27_0")
        com.travelport.schema.universal_v27_0.SavedTripCreateReq parameters,
