 ...
 * 2014-06-21T16:08:17.063-04:00
 * Generated source version: 3.0.0
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v27_0", name = "SavedTripDeleteServicePortType")
...
public interface SavedTripDeleteServicePortType {
    ...
    @WebResult(name = "SavedTripDeleteRsp", targetNamespace = "http://www.travelport.com/schema/universal_v27_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/SavedTripDeleteService")
    public com.travelport.schema.universal_v27_0.SavedTripDeleteRsp service(
        @WebParam(partName = "parameters", name = "SavedTripDeleteReq", targetNamespace = "http://www.travelport.com/schema/universal_v27_0")
        com.travelport.schema.universal_v27_0.SavedTripDeleteReq parameters,
