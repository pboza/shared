 ...
 * 2014-06-21T16:08:17.140-04:00
 * Generated source version: 3.0.0
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v27_0", name = "SavedTripModifyServicePortType")
...
public interface SavedTripModifyServicePortType {
    ...
    @WebResult(name = "SavedTripModifyRsp", targetNamespace = "http://www.travelport.com/schema/universal_v27_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/SavedTripModifyService")
    public com.travelport.schema.universal_v27_0.SavedTripModifyRsp service(
        @WebParam(partName = "parameters", name = "SavedTripModifyReq", targetNamespace = "http://www.travelport.com/schema/universal_v27_0")
        com.travelport.schema.universal_v27_0.SavedTripModifyReq parameters,
