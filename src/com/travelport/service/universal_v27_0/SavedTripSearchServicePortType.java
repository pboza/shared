 ...
 * 2014-06-21T16:08:17.111-04:00
 * Generated source version: 3.0.0
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v27_0", name = "SavedTripSearchServicePortType")
...
public interface SavedTripSearchServicePortType {
    ...
    @WebResult(name = "SavedTripSearchRsp", targetNamespace = "http://www.travelport.com/schema/universal_v27_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/SavedTripSearchService")
    public com.travelport.schema.universal_v27_0.SavedTripSearchRsp service(
        @WebParam(partName = "parameters", name = "SavedTripSearchReq", targetNamespace = "http://www.travelport.com/schema/universal_v27_0")
        com.travelport.schema.universal_v27_0.SavedTripSearchReq parameters,
