...
public class ScheduleChangeService extends Service {
    ...
    public final static QName SERVICE = new QName("http://www.travelport.com/service/universal_v27_0", "ScheduleChangeService");
    public final static QName AckScheduleChangeServicePort = new QName("http://www.travelport.com/service/universal_v27_0", "AckScheduleChangeServicePort");
    static {
        URL url = null;
        try {
