 ...
 * 2014-06-21T16:08:17.144-04:00
 * Generated source version: 3.0.0
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v27_0", name = "UniversalRecordImportServicePortType")
...
public interface UniversalRecordImportServicePortType {
    ...
    @WebResult(name = "UniversalRecordImportRsp", targetNamespace = "http://www.travelport.com/schema/universal_v27_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/UniversalRecordService")
    public com.travelport.schema.universal_v27_0.UniversalRecordImportRsp service(
        @WebParam(partName = "parameters", name = "UniversalRecordImportReq", targetNamespace = "http://www.travelport.com/schema/universal_v27_0")
        com.travelport.schema.universal_v27_0.UniversalRecordImportReq parameters,
