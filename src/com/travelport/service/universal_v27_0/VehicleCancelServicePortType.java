 ...
 * 2014-06-21T16:08:17.066-04:00
 * Generated source version: 3.0.0
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v27_0", name = "VehicleCancelServicePortType")
...
public interface VehicleCancelServicePortType {
    ...
    @WebResult(name = "VehicleCancelRsp", targetNamespace = "http://www.travelport.com/schema/universal_v27_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/VehicleService")
    public com.travelport.schema.universal_v27_0.VehicleCancelRsp service(
        @WebParam(partName = "parameters", name = "VehicleCancelReq", targetNamespace = "http://www.travelport.com/schema/universal_v27_0")
        com.travelport.schema.universal_v27_0.VehicleCancelReq parameters,
