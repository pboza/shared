 ...
 * 2014-06-21T16:08:17.070-04:00
 * Generated source version: 3.0.0
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v27_0", name = "VehicleReservationServicePortType")
...
public interface VehicleReservationServicePortType {
    ...
    @WebResult(name = "VehicleCreateReservationRsp", targetNamespace = "http://www.travelport.com/schema/universal_v27_0", partName = "result")
    @WebMethod(action = "http://localhost:8080/kestrel/VehicleService")
    public com.travelport.schema.universal_v27_0.VehicleCreateReservationRsp service(
        @WebParam(partName = "parameters", name = "VehicleCreateReservationReq", targetNamespace = "http://www.travelport.com/schema/universal_v27_0")
        com.travelport.schema.universal_v27_0.VehicleCreateReservationReq parameters,
